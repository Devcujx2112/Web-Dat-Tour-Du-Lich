...
<div class="product-details mt-4" style="margin-bottom: -100px;">
    <div class="left-column">
      <div class="BoLoc">
        ...
        <span class="KhuVuc" style="margin-bottom: 25px; margin-top: 20px;">Miền Bắc</span>
    ...
    // chọn vào bảng db
    $lietke_sql = "SELECT * FROM tbl_dulich WHERE mien ='Miền Bắc' ";
    //Thực thi câu lệnh
    ...
    ?>
        <div class="note">
          <div class="card" style="width: 20rem">
                <img src="img/<?= $r['image']; ?>" class="card-img-top">
                <div class="card-body">
                  ...
                  <p class="card-text" style="margin-top: 20px; margin-bottom: -5px;">Mã Tour : <span style="font-weight: bold; color: #2d4271;"><?=$r['MaTour']; ?></span> </p>
    ...
    <?php }?>
        <!-- <div class="note">
          <div class="card" style="width: 20rem">
            <img src="img/mienbac2.jpg" class="card-img-top" alt="Sapa - Hạ Long">
            <div class="card-body">
              <p style="font-size: 13px; font-family: Arial, Helvetica, sans-serif; margin-bottom: -1px;">18/01/2024 - 6N5Đ - Giờ đi: 07:00</p>
              <a href="ThanhToan.html" class="no-underline">
              <h5 class="card-title" style="margin-top: 6px;">Sapa - Fansipan - Hà Nội - Yên Tử - Hạ Long - Ninh Bình - Tràng An - Bái Đính</h5>
              </a>
              ...
              <span class="GiaTien" style="font-weight: bold; color: red; display: block; margin-top: 10px; margin-bottom: 10px;">10.990.000 ₫</span>
        ...
        <div class="note">
          <div class="card" style="width: 20rem">
            <img src="img/MienBac3.jpg" class="card-img-top" alt="Sơn La - Mộc Châu">
            <div class="card-body">
              <p style="font-size: 13px; font-family: Arial, Helvetica, sans-serif; margin-bottom: -1px;">19/01/2024 - 5N4Đ - Giờ đi: 06:00</p>
              <a href="ThanhToan.html" class="no-underline">
              <h5 class="card-title" style="margin-top: 6px;">Hà Nội - Vịnh Hạ Long - Sapa - Bản Cát Cát - Fansipan (Khách sạn 3&4 sao)</h5>
              </a>
              ...
              <span class="GiaTien" style="font-weight: bold; color: red; display: block; margin-top: 10px; margin-bottom: 10px;">9.990.000 ₫</span>
              <a href="ThanhToan.html" class="btn btn-danger" style="font-size: 14px;"><i class="fa-solid fa-cart-shopping" style="margin-right: 5px;"></i> Đặt ngay</a>
              <a href="ThanhToan.html" class="btn btn-outline-primary" style="font-size: 14px; margin-left: 75px;" >Xem chi tiết</a>
            </div>
          </div>       
        ...
        <div class="note">
          <div class="card" style="width: 20rem">
            <img src="img/MienBac4.jpg" class="card-img-top" alt="Sơn La - Mộc Châu">
            <div class="card-body">
              <p style="font-size: 13px; font-family: Arial, Helvetica, sans-serif; margin-bottom: -1px;">24/01/2024 - 7N6Đ - Giờ đi: 17:00</p>
              <a href="ThanhToan.html" class="no-underline">
              <h5 class="card-title" style="margin-top: 6px;">Đông Bắc: Hà Nội - Hà Giang - Lũng Cú - Đồng Văn - Mã Pí Lèng - Mèo Vạc - Cao Bằng - Thác Bản Giốc - Hồ Ba Bể</h5>
              </a>
              ...
              <span class="GiaTien" style="font-weight: bold; color: red; display: block; margin-top: 10px; margin-bottom: 10px;">17.990.000 ₫</span>
              <a href="ThanhToan.html" class="btn btn-danger" style="font-size: 14px;"><i class="fa-solid fa-cart-shopping" style="margin-right: 5px;"></i> Đặt ngay</a>
              <a href="ThanhToan.html" class="btn btn-outline-primary" style="font-size: 14px; margin-left: 75px;" >Xem chi tiết</a>
            </div>
          </div>       
        ...
        <div class="note">
          <div class="card" style="width: 20rem">
            <img src="img/MienBac6.jpg" class="card-img-top" alt="Sapa - Bản Cát Cát">
            <div class="card-body">
              <p style="font-size: 13px; font-family: Arial, Helvetica, sans-serif; margin-bottom: -1px;">26/01/2024 - 4N3Đ - Giờ đi: 17:45</p>
              <a href="ThanhToan.html" class="no-underline">
              <h5 class="card-title" style="margin-top: 6px;">Sapa - Bản Cát Cát - Fansipan - Lào Cai - Hà Khẩu - Công viên Sơn Lâm (Vân Nam, Trung Quốc)</h5>
              </a>
              <p class="card-text" style="margin-top: 20px; margin-bottom: -5px;">Nơi khởi hành : <span style="font-weight: bold; color: #2d4271;">TP Hồ Chí Minh</span> </p>
              <span class="GiaTien" style="font-weight: bold; color: red; display: block; margin-top: 10px; margin-bottom: 10px;">7.790.000 ₫</span>
              <a href="ThanhToan.html" class="btn btn-danger" style="font-size: 14px;"><i class="fa-solid fa-cart-shopping" style="margin-right: 5px;"></i> Đặt ngay</a>
              <a href="ThanhToan.html" class="btn btn-outline-primary" style="font-size: 14px; margin-left: 75px;" >Xem chi tiết</a>
            </div>
          </div>       
        ...
        <div class="note">
          <div class="card" style="width: 20rem">
            <img src="img/MienBac5.jpg" class="card-img-top" alt="Sơn La - Mộc Châu">
            <div class="card-body">
              <p style="font-size: 13px; font-family: Arial, Helvetica, sans-serif; margin-bottom: -1px;">26/01/2024 - 5N4Đ - Giờ đi: 17:45</p>
              <a href="ThanhToan.html" class="no-underline">
              <h5 class="card-title" style="margin-top: 6px;">Tinh hoa ẩm thực Việt: Ninh Bình - Tuyệt Tịnh Cốc - Nam Định - Hà Nam - Cá kho Làng Vũ Đại - Hà Nội</h5>
              </a>
