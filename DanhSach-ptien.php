...
<li><a href="formlogin.php"><i class="fa-solid fa-user" style="color: white; margin-top:3px"></i></a></li>
  ...
  <div class="container" style="padding-top: 100px;">
    <h2 style="color:#2d4271; font-weight: bold;">Danh sách đặt phương tiện</h2>
    <br>
  <table class="table">
...
// chọn vào bảng db
    $lietke_sql = "SELECT * FROM tbl_phuongtien order by HoVaTen, SoDienThoai";
    //Thực thi câu lệnh
    ...
    ?>
      <tr>
        ...
        if($r['KhuVuc'] == "hnoi"){
          echo "Hà Nội";
        }if($r['KhuVuc'] == "hochiminh"){
          echo "TP Hồ Chí Minh";
        }if($r['KhuVuc'] == "quangninh"){
          echo "Quảng Ninh";
        }if($r['KhuVuc'] == "danang"){
          echo "Đà Nẵng";
        }
        ...
        <td><?php echo $r['DiemDon'];?></td>
        <td><?php 
        if($r['LoaiXe'] == "xe4cho"){
        echo "Xe 4 chỗ";
        } elseif($r['LoaiXe'] == "xe7cho"){
        echo "Xe 7 chỗ";
        } elseif($r['LoaiXe'] == "xe16cho"){
        echo "Xe 16 chỗ";
        } 
        ?></td>    

        <td><?php echo $r['DiemDen'];?></td>
        ...
        <td><?php echo $r['NgayThue'];?></td>
      
      <td><a href="admin/Sua-ptien.php?sid=<?= $r['uid'];?>" class ="btn btn-warning">Sửa</a>      
        <a onclick="return confirm('Bạn có muốn xóa thông tin người này không?');" href="admin/Xoa-ptien.php?sid=<?=$r['uid'];?>" class="btn btn-danger">Xóa</a>
      </tr>
  <?php
    }
  ?>
    ...
    <form action="PhuongTien.php" method="post">
        <!-- Các trường và nút submit nếu cần -->
        <input type="submit" value="Đặt xe" class="btn btn-primary">    
       </form>
      </div>
