...
//Lấy thông tin sql
$edit_sql = "SELECT * FROM `tbl_phuongtien` WHERE `uid` = '$id'";
...
<div class="p-3">
  <form id="form" action="update-ptien.php" method="post">
  <input type="hidden" name="sid" value="<?php echo $id; ?>" id="">
    <div class="container">
        ...
        <div class="input-group mb-1">
          <div class="input-group-text"style="width: 123.54px; height: 37.6px;">
            ...
            <select class="form-select form-control" name="LoaiXe">
              <option value="xe4cho"  <?= $row['LoaiXe'] == "xe4cho" ? 'selected' : '';?> >Xe 4 chỗ - Xe hợp đồng</option>
              <option value="xe7cho"  <?= $row['LoaiXe'] == "xe7cho" ? 'selected' : '';?>>Xe 7 chỗ - Xe hợp đồng</option>
              <option value="xe16cho" <?= $row['LoaiXe'] == "xe16cho" ? 'selected' : '';?>>Xe 16 chỗ - Xe hợp đồng</option>
            </select>
        </div>
        <div class="input-group mb-1">
          <div class="input-group-text"style="width: 123.54px; height: 37.6px;">
        ...
        <div class="input-group mb-1">
          <div class="input-group-text"style="width: 123.54px; height: 37.6px;">
            ...
            <select class="form-select form-control" name="GoiThue">
              <option value="1chieu" <?= $row['GoiThue'] == "1chieu" ? 'selected' : '';?>>Gói đi 1 chiều</option>
              <option value="2chieu"  <?= $row['GoiThue'] == "2chieu" ? 'selected' : '';?>>Gói đi 2 chiều</option>
            </select>
        </div>
      ...
      <button type="submit" class="btn btn-success" style="margin-top: 20px;" name="btn-pocess">Cập nhật</button>
    </div>
    </form>
</div>
