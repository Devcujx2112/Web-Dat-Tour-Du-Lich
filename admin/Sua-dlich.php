...
<body>
    ...
    $id = $_GET['sid'];
    $sql_up = "SELECT * FROM tbl_dulich where `uid`='$id'";
    $query_up = mysqli_query($conn, $sql_up);
    $row = mysqli_fetch_array($query_up);
    ...
    if (isset($_POST['submit'])) {
        ...
        if (isset($_FILES['new_image']['name']) && $_FILES['new_image']['name'] != "") {
            // Nếu có file ảnh mới update -> sử dụng
    ...
    <div class="card-body">
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" value="<?= $row['TieuDe'] ?>" name="TieuDe" id="" class="form-control" placeholder=""
                    aria-describedby="helpId">
            </div>
            <div class="form-group">
                <label for="image">Image</label>
                <input value="<?= $row['image'] ?>" name="image" id="" class="form-control" placeholder=""
                    aria-describedby="helpId">
                <input value="<?= $row['image'] ?>" type="file" name="new_image" id="" class="form-control"
                    placeholder="" aria-describedby="helpId">
            </div>
            <div class="form-group">
                <label for="intro">Thời gian</label>
                <input type="text" value="<?= $row['Time'] ?>" name="Time" id="" class="form-control" placeholder=""
                    aria-describedby="helpId">
            </div>
            <div class="form-group">
                <label for="detail">Nơi khởi hành</label>
                <input type="text" value="<?= $row['NoiKhoiHanh'] ?>" name="NoiKhoiHanh" id="" class="form-control"
                    placeholder="" aria-describedby="helpId">
            </div>
            <div class="form-group">
                <label for="status">Giá</label>
                <input type="text" value="<?= $row['Gia'] ?>" name="Gia" id="" class="form-control" placeholder=""
                    aria-describedby="helpId">
            </div>
            <div class="form-group">
                <label for="status">Tên miền</label>
                <input type="text" value="<?= $row['mien'] ?>" name="mien" id="" class="form-control" placeholder=""
                    aria-describedby="helpId">
            </div>
            <div class="form-group">
                <label for="status">Mã Tour</label>
                <input type="text" value="<?= $row['MaTour'] ?>" name="MaTour" id="" class="form-control" placeholder=""
                    aria-describedby="helpId">
            </div>
