...
<li><a href="formlogin.php"><i class="fa-solid fa-user" style="color: white; margin-top:3px"></i></a></li>
  ...
  <div class="container" style="padding-top: 100px;">
    <h2 style="color:#2d4271; font-weight: bold;">Danh sách đặt phòng khách sạn</h2>
    <br>
  <table class="table">
  ...
  <?php 
    // chọn vào bảng db
    $lietke_sql = "SELECT * FROM tbl_khachsan order by HoVaTen, SoDienThoai";
    //Thực thi câu lệnh
    ...
    ?>
      <tr>
        ...
        <td><?php echo $r['SoPhong'];?></td>
        <td><?php echo $r['NgayThue'];?></td>
        <td><?php echo $r['NgayTra'];?></td>
        <td><?php echo $r['note'];?></td>
      
      
      <td><a href="admin/Sua-ksan.php?sid=<?= $r['uid'];?>" class ="btn btn-warning">Sửa</a>      
        <a onclick="return confirm('Bạn có muốn xóa thông tin người này không?');" href="admin/Xoa-ksan.php?sid=<?=$r['uid'];?>" class="btn btn-danger">Xóa</a>
      </td>
      </tr>
  <?php
    }
  ?>
    ...
    <form action="KhachSan.php" method="post">
