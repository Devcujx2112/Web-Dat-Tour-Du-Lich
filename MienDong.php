...
<div class="product-details mt-4" style="margin-bottom: -100px;">
    <div class="left-column">
      <div class="BoLoc">
        ...
        <span class="KhuVuc" style="margin-bottom: 25px; margin-top: 20px;">Miền Đông</span>
    ...
    <?php 
    // chọn vào bảng db
    $lietke_sql = "SELECT * FROM tbl_dulich WHERE mien ='Miền Đông' ";
    //Thực thi câu lệnh
    ...
    <?php }?>
        <!-- <div class="note">
          <div class="card" style="width: 20rem">
            <img src="img/MienDong2.jpg" class="card-img-top" alt="Phước Hải">
            <div class="card-body">
              <p style="font-size: 13px; font-family: Arial, Helvetica, sans-serif; margin-bottom: -1px;">20/01/2024 - Trong Ngày - Giờ đi: 05:30</p>
              <a href="ThanhToan.html" class="no-underline">
              <h5 class="card-title" style="margin-top: 6px;">Phước Hải: Trải nghiệm dịch vụ 4 sao tại Trân Châu Resort - Hồ Tràm - Hamptons Pier </h5>
              </a>
              ...
              <span class="GiaTien" style="font-weight: bold; color: red; display: block; margin-top: 10px; margin-bottom: 10px;">599.000 ₫</span>
        ...
        <div class="note">
          <div class="card" style="width: 20rem">
            <img src="img/MienDong3.jpg" class="card-img-top" alt="Tây Ninh">
            <div class="card-body">
              <p style="font-size: 13px; font-family: Arial, Helvetica, sans-serif; margin-bottom: -1px;">21/01/2024 - Trong Ngày - Giờ đi: 05:30</p>
              <a href="ThanhToan.html" class="no-underline">
              <h5 class="card-title" style="margin-top: 6px;">Tây Ninh: Hành Trình Chinh Phục Nóc Nhà Nam Bộ Tham Quan 3 Tuyến Cáp Treo Chùa Hang - Tâm An - Vân Sơn</h5>
              </a>
              ...
              <span class="GiaTien" style="font-weight: bold; color: red; display: block; margin-top: 10px; margin-bottom: 10px;">1.190.000 ₫</span>
              <a href="ThanhToan.html" class="btn btn-danger" style="font-size: 14px;"><i class="fa-solid fa-cart-shopping" style="margin-right: 5px;"></i> Đặt ngay</a>
              <a href="ThanhToan.html" class="btn btn-outline-primary" style="font-size: 14px; margin-left: 75px;" >Xem chi tiết</a>
            </div>
          </div>       
        ...
        <div class="note">
          <div class="card" style="width: 20rem">
            <img src="img/MienDong4.jpg" class="card-img-top" alt="Tour Trekking - Cần Giờ">
            <div class="card-body">
              <p style="font-size: 13px; font-family: Arial, Helvetica, sans-serif; margin-bottom: -1px;">21/01/2024 - Trong Ngày - Giờ đi: 07:00</p>
              <a href="ThanhToan.html" class="no-underline">
              <h5 class="card-title" style="margin-top: 6px;">Tour Trekking - Cần Giờ: Lắng Nghe hơi thở của Rừng - chèo Sup Xuyên Rừng ngập mặn</h5>
              </a>
              ...
              <span class="GiaTien" style="font-weight: bold; color: red; display: block; margin-top: 10px; margin-bottom: 10px;">2.590.000 ₫</span>
              <a href="ThanhToan.html" class="btn btn-danger" style="font-size: 14px;"><i class="fa-solid fa-cart-shopping" style="margin-right: 5px;"></i> Đặt ngay</a>
              <a href="ThanhToan.html" class="btn btn-outline-primary" style="font-size: 14px; margin-left: 75px;" >Xem chi tiết</a>
            </div>
          </div>       
        ...
        <div class="note">
          <div class="card" style="width: 20rem">
            <img src="img/MienDong5.jpg" class="card-img-top" alt="Côn Đảo">
            <div class="card-body">
              <p style="font-size: 13px; font-family: Arial, Helvetica, sans-serif; margin-bottom: -1px;">26/01/2024 - 3N2Đ - Giờ đi: 00:00</p>
              <a href="ThanhToan.html" class="no-underline">
                <h5 class="card-title" style="margin-top: 6px;">Côn Đảo: Bảo Tàng Côn Đảo - Dinh Chúa Đảo - Khám Phá Thiên Đường Của Biển</span></h5>
              </a>
              ...
              <class class="GiaTien" style="font-weight: bold; color: red; display: block; margin-top: 10px; margin-bottom: 10px;">7.390.000 ₫</class>
              <a href="ThanhToan.html" class="btn btn-danger" style="font-size: 14px;"><i class="fa-solid fa-cart-shopping" style="margin-right: 5px;"></i> Đặt ngay</a>
              <a href="ThanhToan.html" class="btn btn-outline-primary" style="font-size: 14px; margin-left: 75px;" >Xem chi tiết</a>
            </div>
          </div>       
        ...
        <div class="note"> -->
          <!-- <div class="card" style="width: 20rem">
            <img src="img/MienDong6.jpg" class="card-img-top" alt="Phú Quốc - Thiên đường giải trí VinWonders">
            <div class="card-body">
              <p style="font-size: 13px; font-family: Arial, Helvetica, sans-serif; margin-bottom: -1px;">26/01/2024 - 4N3Đ - Giờ đi: 15:35</p>
              <a href="ThanhToan.html" class="no-underline">
              <h5 class="card-title" style="margin-top: 6px;">Phú Quốc - Thiên đường giải trí VinWonders - Vinpearl Safari - Hòn Thơm Nature Park - Cáp Treo Vượt Biển - Công Viên Nước Aquatopia</h5>
              </a>
              <p class="card-text" style="margin-top: 20px; margin-bottom: -5px;">Nơi khởi hành : <span style="font-weight: bold; color: #2d4271;">Hà Nội</span> </p>
              <span class="GiaTien" style="font-weight: bold; color: red; display: block; margin-top: 10px; margin-bottom: 10px;">11.590.000 ₫</span>
              <a href="ThanhToan.html" class="btn btn-danger" style="font-size: 14px;"><i class="fa-solid fa-cart-shopping" style="margin-right: 5px;"></i> Đặt ngay</a>
              <a href="ThanhToan.html" class="btn btn-outline-primary" style="font-size: 14px; margin-left: 75px;" >Xem chi tiết</a>
            </div>
          </div>        -->
